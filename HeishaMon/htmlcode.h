...
static const char websocketJS[] PROGMEM =
  ...
  "            if (jsonObject.data.hasOwnProperty('table') && (jsonObject.data.table === 'dallasvalues')) {"
  "              let elementid = `SensorID-${jsonObject.data.sensorID}-Temperature`;"
  "              document.getElementById(elementid).setAttribute(\"class\",\"w3-opacity-max\");"  
  "              document.getElementById(elementid).textContent = jsonObject.data.value;"
  "              void document.getElementById(elementid).offsetWidth;"
  "              document.getElementById(elementid).setAttribute(\"class\",\"w3-animate-opacity\");"  
  "            }"
  "          }"
  "        } else {"
  "          let obj = document.getElementById(\"cli\");"
