...
"        <td style=\"text-align:left\">"
"          <input type=\"number\" id=\"s0_ppkwh_1\" onchange=\"changeMinWatt(2)\" name=\"s0_2_ppkwh\" value=\"\">"
"        </td>"
"      </tr>"
"      <tr>"
"        <td style=\"text-align:right; width: 50%\">S0 port 2 reporting interval during standby/low power usage:</td>"
"        <td style=\"text-align:left\">"
"          <input type=\"number\" id=\"s0_interval_1\" onchange=\"changeMinWatt(2)\" name=\"s0_2_interval\" value=\"\"> seconds"
"        </td>"
"      </tr>"
"      <tr>"
"        <td style=\"text-align:right; width: 50%\">S0 port 2 minimal pulse width:</td>"
"        <td style=\"text-align:left\">"
"          <input type=\"number\" id=\"s0_minpulsewidth_1\" name=\"s0_2_minpulsewidth\" value=\"\"> milliseconds"
"        </td>"
"      </tr>"
"      <tr>"
"        <td style=\"text-align:right; width: 50%\">S0 port 2 maximal pulse width:</td>"
"        <td style=\"text-align:left\">"
"          <input type=\"number\" id=\"s0_maxpulsewidth_1\" name=\"s0_2_maxpulsewidth\" value=\"\"> milliseconds"
"        </td>"
"      </tr>"
"      <tr>"
