...
static const char websocketJS[] PROGMEM =
  ...
  "            if (jsonObject.data.hasOwnProperty('dallasvalues')) {"
  "              let elementid = `SensorID-${jsonObject.data.dallasvalues.sensorID}-Temperature`;"
  "              document.getElementById(elementid).setAttribute(\"class\",\"w3-opacity-max\");"  
  "              document.getElementById(elementid).textContent = jsonObject.data.dallasvalues.value;"
